...
/** Alert circle — form error */
export function ErrorCircleIcon({ size = 24, className = '' }) {
  return svg(
    <path d="M12 9v3.75m0 3h.008v.008H12v-.008ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />,
    size,
    className,
  )
}
